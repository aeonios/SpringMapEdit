...
public class ErrorHandler extends Dialog implements Thread.UncaughtExceptionHandler
{
 ...
 */
	public ErrorHandler(Shell parent)
	{
		super(parent, SWT.DIALOG_TRIM);
		this.display = parent.getDisplay();
		this.shell = new Shell(parent);
		this.shell.setText("Critical Error");
	}
	...
	private void createDialogArea()
	{
		...
		l.setText("Critcal error: " + str + ", Report this error to the Spring Map Edit developers.\nExiting now.");
