 ...
 *
 */
public class MirrorMapDialog extends Dialog
{
	 ...
	 * @param parent
	 */
	public MirrorMapDialog(Shell parent, SpringMapEditGUI smeGUI)
	{
		super(parent, SWT.DIALOG_TRIM);
		this.smeGUI = smeGUI;
		display = parent.getDisplay();
		shell = new Shell(parent);
		shell.setText("Mirror Map");
	...
	private void createDialogArea()
	{
		...
		lOffset.setText("Set Offset: " + offset);
		lOffset.setToolTipText("Sets the offset of mirroring.");
		...
		b.addSelectionListener(new SelectionAdapter() 
		{
			public void widgetSelected(SelectionEvent e)
			{
				Command cmd = new Command(new Object[] {}) 
				{
					...
					{
						smeGUI.sme.map.mirrorMap(start, length, offset, vertically);
					}
				};
