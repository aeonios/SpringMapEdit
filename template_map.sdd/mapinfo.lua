...
-- SME template mapinfo.lua

local mapinfo = {
	name        = "SME Template Map Folder",
	shortname   = "STM",
	description = "SME Template Map Folder\nDo not play!",
	author      = "Spring Map Edit",
	version     = "0.0",
	...
	teams = {
		...
		[1] = {startPos = {x = 10000, z = 100}},
		[2] = {startPos = {x = 100, z = 10000}},
		[3] = {startPos = {x = 10000, z = 10000}},
	},
	...
	resources = {
		...
		--grassShadingTex = "",
		detailTex = "maps/detailtex.png",
		specularTex = "maps/specular",
		--splatDetailTex = "",
		--splatDistrTex = "",
		--skyReflectModTex = "",
		--detailNormalTex = "",
